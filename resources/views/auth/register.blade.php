                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <span class="input-group-text" id="basic-addon1"
                                            ...
                                            <input id="name" type="text" class="form-control swt-input" name="name"
                                                   ...
                                                   placeholder="Ime i prezime" style="background-color: #f8f8f8; ">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <span class="input-group-text" id="basic-addon1"
                                            ...
                                            <input type="text" class="form-control swt-input" id="inputPhone"
                                                   name="phone"
                                                   placeholder="Broj telefona" style="background-color: #f8f8f8;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                               <span class="input-group-text" id="basic-addon1" for="select"
                                                ...
                                                <select class="form-control noborder" id="select" name="faculty" style="height: 52px; background-color: #f8f8f8;">
                                                    <option value="Agronomski i prehrambeno-tehnološki fakultet">
                                                        Agronomski i
                                                    ...
                                                    <option value="Fakultet zdravstvenih studija ">Fakultet
                                                        zdravstvenih studija
                                                    </option>
                                                    <option value="Građevinski fakultet">Građevinski fakultet
                                                    </option>
                                                    <option value="Farmaceutski fakultet">Farmaceutski fakultet
                                                    </option>
                                                </select>
                                ...
                                <div class="form-group row justify-content-center">
                                    <div class="col-md-9" style="padding: 8px !important;">
                                        ...
                                        <span class="input-group-text" id="basic-addon1"
                                            ...
                                            <input type="text" class="form-control noborder" id="inputStudy"
                                                   name="study"
